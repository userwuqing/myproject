...
import com.wq.service.impl.PaymentServiceFallbackFactory;
 ...
 */
//@FeignClient(value = "CLOUD-PYMENT-SERVICE", fallback = PaymentServiceFallbackImpl.class) //找对应微服务的service，避免不同服务有一样的service
@FeignClient(value = "CLOUD-PYMENT-SERVICE", fallbackFactory = PaymentServiceFallbackFactory.class) //找对应微服务的service，避免不同服务有一样的service
